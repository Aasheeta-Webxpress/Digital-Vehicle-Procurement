...
import { Search, Download, UserCircle, ChevronDown, Check } from 'lucide-react';
          ...
          <div className="relative" ref={menuRef}>
            ...
            >
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[9px] text-blue-600 font-bold mt-1 uppercase tracking-tight">{currentUser.role} View</p>
              </div>
